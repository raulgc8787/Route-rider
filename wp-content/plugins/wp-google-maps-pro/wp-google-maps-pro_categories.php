...
function wpgmza_pro_return_category_dropdown_list($map_id, $show_all = true, $array = false) {
    ...
    $sql = "SELECT * FROM `$wpgmza_tblname_category_maps` LEFT JOIN `$wpgmza_tblname_categories` ON $wpgmza_tblname_category_maps.cat_id = $wpgmza_tblname_categories.id WHERE `map_id` = '$map_id' OR `map_id` = '0' ORDER BY `category_name` ASC";
